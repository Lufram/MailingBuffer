...
public class NumberToCheck extends Thread {
	...
	public void isPrime(long num) {
		long cont = 0;
		// Divide el numero por todos los numeros entre el numero y 1 y suma 1 al
		// contador cada vez que el resto es 0
	...
	public void run() {
		...
		// Imprime por la informacicionn del numero y el proceso
		System.out.println("El numero " + num + " ha sido procesado por el hilo: " + Thread.currentThread().getName()
				+ ". El proceso ha tardado: " + time + " seg. Resultado: " + numIsPrime);
	}
